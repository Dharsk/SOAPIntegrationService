...
import com.example.integrationservice.service.OrderServiceUsingCamel;

@RestController
@RequestMapping("/orders/camel")
public class OrderControllerWithCamel {

	@Autowired
    private OrderServiceUsingCamel orderService;
